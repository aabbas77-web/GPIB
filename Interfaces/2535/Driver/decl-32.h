...
#define SDC  0x04  /* ooo GPIB selected device clear           */
#define PPC  0x05  /* GPIB parallel poll configure         */
#define GET  0x08  /* ooo  GPIB group execute trigger           */
#define TCT  0x09  /* GPIB take control                    */
#define LLO  0x11  /* GPIB local lock out                  */
#define DCL  0x14  /* ooo  GPIB device clear                    */
...
extern int __stdcall ibfindA   (PCHAR udname);
extern int __stdcall ibbnaA    (int ud, PCHAR udname);
extern int __stdcall ibrdfA    (int ud, PCHAR filename);
extern int __stdcall ibwrtfA   (int ud, PCHAR filename);
...
extern int __stdcall ibevent  (int ud, PSHORT event);
...
extern int __stdcall ibmessage(int ud, int MsgMask, HWND hWnd, UINT wMsg, WPARAM wParam, LPARAM lParam);
...
extern int __stdcall ibrdkey  (int ud, PVOID buf, int cnt);
...
extern int __stdcall ibwrtkey (int ud, PVOID buf, int cnt);
extern int __stdcall ibxtrc   (int ud, PVOID buf, LONG cnt);


/**************************************************************************/
/*  VXI Extensions Function Prototypes  */

extern void __stdcall GenerateREQF(int boardID, unsigned short addr);
extern void __stdcall GenerateREQT(int boardID, unsigned short addr);
extern void __stdcall GotoMultAddr(int boardID,
                                   unsigned short type,
                                   unsigned short (*addrfunc)(),
                                   unsigned short (*spollfunc)());
